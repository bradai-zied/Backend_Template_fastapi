from mongoengine import connect, DoesNotExist, errors
from config.config import DB_URL, DB_PORT, DB_USERNAME, DB_PASSWORD, DATABASE_NAME
...
class MongoDBHandler:
    ...
    def connect_to_database(self):
        try:
            self.connection = connect(self.db_name, username=DB_USERNAME, password=DB_PASSWORD,
                                      host=self.host, port=self.port, alias='default')
